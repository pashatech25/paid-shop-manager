...
const supabase = createClient(
  ...
  process.env.SUPABASE_SERVICE_ROLE_KEY || process.env.VITE_SUPABASE_SERVICE_ROLE_KEY || process.env.VITE_PUBLIC_SUPABASE_ANON_KEY || process.env.VITE_SUPABASE_ANON_KEY
);
...
export default async function handler(req, res) {
  ...
  const usedKey = process.env.SUPABASE_SERVICE_ROLE_KEY || process.env.VITE_SUPABASE_SERVICE_ROLE_KEY || process.env.VITE_PUBLIC_SUPABASE_ANON_KEY || process.env.VITE_SUPABASE_ANON_KEY;
  console.log('Using Supabase key type:', usedKey ? (usedKey.includes('service_role') ? 'SERVICE_ROLE' : 'ANON') : 'NONE');
